...
var accnoBlocksRight = rightAccno.toString().split(",").join("")
  ...
  samplepdf = samplepdfFunc(firmname,
                              branchname,
                              date,
                              totalamount,
                              twothousandqty,
            ...
            <table>
              ...
              <tbody>
                <tr>
                  ...
                  <td></td>
                  <td></td>
                  <td>${twothousandqty} X2000</td>
                  <td>${twothousandamount}</td>
                </tr>
                <tr>
                  <td></td>
                  <td></td>
                  <td></td>
                  <td>${fivehundredqty} X500</td>
                  <td>${fivehundredamount} </td>
                </tr>
                <tr>
                  <td></td>
                  <td></td>
                  <td></td>
                  <td>${twohundredqty} X200</td>
                  <td>${twohundredamount} </td>
                </tr>
                <tr>
                  <td></td>
                  <td></td>
                  <td></td>
                  <td>${onehundredqty} X100</td>
                  <td>${onehundredamount} </td>
                </tr>
                <tr>
                  <td></td>
                  <td></td>
